...
class MessagesPresenter(
    ...
    videoNoteComposerPresenterFactory: DefaultVideoNoteComposerPresenter.Factory,
    ...
    private val videoNoteComposerPresenter = videoNoteComposerPresenterFactory.create(
        timelineMode = timelineController.mainTimelineMode()
    )
    ...
    override fun present(): MessagesState {
        ...
        val videoNoteComposerState = videoNoteComposerPresenter.present()
