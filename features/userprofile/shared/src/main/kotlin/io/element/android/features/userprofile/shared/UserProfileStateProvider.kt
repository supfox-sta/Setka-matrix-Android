...
fun aUserProfileState(
    ...
    bio: String? = "О себе",
    profileColorHex: String? = "#6A5ACD",
    badgeEmojiMxcUrl: String? = null,
    statusEmojiMxcUrl: String? = null,
    profileBackgroundMxcUrl: String? = null,
    email: String? = "daniel@example.com",
    phone: String? = "+7 999 123-45-67",
    lastSeenText: String? = "В сети",
    ...
    profileBackgroundMxcUrl = profileBackgroundMxcUrl,
    email = email,
    phone = phone,
