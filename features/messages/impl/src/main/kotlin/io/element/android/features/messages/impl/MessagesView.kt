...
import io.element.android.features.messages.impl.videonotes.composer.VideoNoteComposerOverlay
...
fun MessagesView(
    ...
    OnLifecycleEvent { _, event ->
        ...
        state.videoNoteComposerState.eventSink(VideoNoteComposerEvent.LifecycleEvent(event))
    }

    KeepScreenOn(state.voiceMessageComposerState.keepScreenOn || state.videoNoteComposerState.keepScreenOn)
    ...
    Box(
        ...
        if (showVideoNoteOverlay) {
            VideoNoteComposerOverlay(
                state = state.videoNoteComposerState,
