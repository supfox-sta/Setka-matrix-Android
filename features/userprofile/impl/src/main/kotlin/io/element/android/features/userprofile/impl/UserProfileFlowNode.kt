            ...
            NavTarget.Root -> {
                val callback = object : UserProfileNodeHelper.Callback {
                    ...
                    override fun startAudioCall(dmRoomId: RoomId) {
                        elementCallEntryPoint.startCall(CallType.RoomCall(sessionId = sessionId, roomId = dmRoomId, isAudioOnly = true))
                    }

                    override fun startVideoCall(dmRoomId: RoomId) {
                        elementCallEntryPoint.startCall(CallType.RoomCall(sessionId = sessionId, roomId = dmRoomId, isAudioOnly = false))
                    }
