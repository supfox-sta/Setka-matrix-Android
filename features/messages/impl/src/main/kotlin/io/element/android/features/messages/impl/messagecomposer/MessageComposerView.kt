...
internal fun MessageComposerView(
    ...
    videoNoteState: VideoNoteComposerState,
    ...
    val onVideoNoteRecorderEvent = { press: VideoNoteRecorderEvent ->
        videoNoteState.eventSink(VideoNoteComposerEvent.RecorderEvent(press))
    }
    ...
    TextComposer(
        ...
        videoNoteState = videoNoteState.videoNoteState,
        ...
        onVideoNoteRecorderEvent = onVideoNoteRecorderEvent,
...
internal fun MessageComposerViewPreview(
    ...
    Column {
        MessageComposerView(
            ...
            videoNoteState = io.element.android.features.messages.api.timeline.videonotes.composer.aVideoNoteComposerState(),
        )
        MessageComposerView(
