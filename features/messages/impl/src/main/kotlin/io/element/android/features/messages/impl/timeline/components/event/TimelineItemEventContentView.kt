...
fun TimelineItemEventContentView(
    ...
    when (content) {
        ...
        is TimelineItemVideoContent -> {
            val inlinePlaybackState = if (content.isVideoNote) {
                val presenter: Presenter<VideoNoteInlinePlaybackState> = presenterFactories.rememberPresenter(content)
                presenter.present()
            } else {
                VideoNoteInlinePlaybackState.empty()
            }
            TimelineItemVideoView(
                ...
                onContentLayoutChange = onContentLayoutChange,
                modifier = modifier,
                videoNoteInlinePlaybackState = inlinePlaybackState,
            )
        }
