...
fun aEditUserProfileState(
    ...
    bio: String = "About me",
    profileColorHex: String = "#7B61FF",
    badgeEmojiMxcUrl: String? = null,
    statusEmojiMxcUrl: String? = null,
    profileBackgroundUrl: String? = null,
    isSetkaPlusActive: Boolean = true,
    badgeEmojiPacks: List<SetkaEmojiPack> = emptyList(),
    ...
    badgeEmojiPacks = badgeEmojiPacks.toImmutableList(),
